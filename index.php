        ...
        <div class="col-lg-8 col-lg-offset-2">
          ...
          <div class="section-heading text-center">
            <div class="wow bounceInDown" data-wow-delay="0.2s">
              <h2>My name is Naoki Tamiya.</h2>
              <h2>Please call me Tammy or Naoki!!</h2>
            </div>
            <p class="wow bounceInUp" data-wow-delay="0.3s">I'm 26 years old from Tottory prefecture:)</p>
          </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          ...
          <img src="img/IMG_6331.jpg" class="img-responsive img-rounded" alt=""/>
        </div>
        <div class="col-md-6">
          <h3><strong>Basic Information</strong></h3>
          <ul>
            <li class="infomation">Hobby
              <ol>
                <li>Overseas travel ( 13countries )</li>
                <li>Fishing</li>
                <li>Business book (100books / 1years)</li>
                <li>Acquisition of a qualification</li>
                <li>Basket ball ( Junior highschool )</li>
                <li>Rock climbing ( Primary school )</li>
              </ol>
            </li>
            <li class="infomation">Special ability
              <ol>
                <li>Cooking</li>
                <li>Ability to take action</li>
                <li>Curiosity</li>
              </ol>
            </li>
          ...
          <dl>
            <dt>Basic lebel</dt>
            <dd>I can only make siple Web site.</dd>
            <dd>I learned programming from a friend for 2month.</dd>
          </dl>
      ...
      <div class="row">
        <div class="col-xs-6 col-sm-3 col-md-3">
          <div class="align-center txt-shadow">
            ...
            <span class="color-white">Entrepreneur</span>
          </div>
        </div>
        <div class="col-xs-6 col-sm-3 col-md-3">
          <div class="align-center txt-shadow">
            ...
            <span class="color-white">Round the trip</span>
          </div>
        </div>
        <div class="col-xs-6 col-sm-3 col-md-3">
          <div class="align-center txt-shadow">
            ...
            <span class="color-white">The fun never stops in my family</span>
          </div>
        </div>
        <div class="col-xs-6 col-sm-3 col-md-3">
          <div class="align-center txt-shadow">
            <div class="icon">
              <i class="fa fas fa-home fa-5x"></i>
            </div>
            <span class="color-white">Multiple residences</span>
          </div>
        </div>
        <div class="col-xs-6 col-sm-3 col-md-3">
          <div class="align-center txt-shadow">
            <div class="icon">
              <i class="fa fas fa-camera-retro fa-5x"></i>
            </div>
            <span class="color-white">Appear on Another Sky</span>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-sm-12 col-md-12 col-lg-12">
          <div class="wow bounceInUp" data-wow-delay="0.4s">
            <div id="owl-works" class="owl-carousel">
              ...
              <div class="item"><a href="img/gallery/IMG_8944.jpg" title="" data-lightbox-gallery="gallery1"><img src="img/gallery/IMG_8944.jpg" class="img-responsive " alt="img"></a></div>
              <div class="item"><a href="img/gallery/IMG_2391.jpg" title="" data-lightbox-gallery="gallery1"><img src="img/gallery/IMG_2391.jpg" class="img-responsive " alt="img"></a></div>
              <div class="item"><a href="img/gallery/IMG_3898.jpg" title="" data-lightbox-gallery="gallery1"><img src="img/gallery/IMG_3898.jpg" class="img-responsive " alt="img"></a></div>
              <div class="item"><a href="img/gallery/IMG_7198.jpg" title="" data-lightbox-gallery="gallery1"><img src="img/gallery/IMG_7198.jpg" class="img-responsive " alt="img"></a></div>
              <div class="item"><a href="img/gallery/IMG_9939.jpg" title="" data-lightbox-gallery="gallery1"><img src="img/gallery/IMG_9939.jpg" class="img-responsive " alt="img"></a></div>
              <div class="item"><a href="img/gallery/IMG_0500.jpg" title="" data-lightbox-gallery="gallery1"><img src="img/gallery/IMG_0500.jpg" class="img-responsive " alt="img"></a></div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-lg-12">
          <p>Copyright &copy; 2019 Naoki Tamiya All Rights Reserved</p>
          <div class="credits">
            <!--
